...
function UserPostEdit() {
  ...
  useEffect(() => {
    ...
    axios.get(`${url}repairs`).then((res) => {
      const persons = res?.data.data;
      setRepair(persons);
    });
    axios.get(`${url}materials`).then((res) => {
      const persons = res?.data.data;
      setMaterials(persons);
    });
    axios.get(`${url}post/${postID}`).then(function (response) {
      ...
      setLongitude(lng);
      setDefaultLocation({
        lat: response.data.data.latitude * 1,
        lng: response.data.data.longitude * 1,
      });
    });
  }, []);
      ...
      <Container>
        <div className="user-profil-wrap">
          ...
          <div className="postEdit">
            ...
            <p>
              {postData.data?.id}
              {content[lang].edit_post}
            </p>

            <div className="saleHouse">
              <FormControl className="selectInp">
                <InputLabel id="Sotish turi">
                  {content[lang].edit_saleType}
                </InputLabel>
                <Select
                  id="Sotish turi"
              ...
              <FormControl className="selectInp">
                <InputLabel id="Uy turi">
                  {content[lang].edit_houseType}
                </InputLabel>
                <Select
                  id="Uy turi"
            ...
            <div className="saleHouse">
              <FormControl className="selectInp">
                <InputLabel id="Tamir turi">
                  {content[lang].edit_repairType}
                </InputLabel>
                <Select
                  id="Tamir turi"
              ...
              <FormControl className="selectInp">
                <InputLabel id="Material turi">
                  {content[lang].edit_materialType}
                </InputLabel>
                <Select
                  id="Material turi"
            ...
            <div className="saleHouse">
              <FormControl className="selectInp">
                <InputLabel id="Viloyat">
                  {content[lang].edit_Region}
                </InputLabel>
                <Select
                  id="Viloyat"
            ...
            <div className="images">
              <label htmlFor="addImgBtn" className="addImgBtn">
                Add Image
              </label>
              <input
                type="file"
              ...
              {photo.map((type) => (
                <div className="img" key={v4()}>
                  <img
                    src={process.env.REACT_APP_URL + type}
                    alt=""
                    style={{
                      width: "100%",
                      height: "100%",
            ...
            <div className="videos">
              <div className="addVid">
                <label htmlFor="addVideo" className="addVideo">
                  {content[lang].edit_Video}
                </label>
                <input
                  className="inp"
                  type="file"
            ...
            <div className="document">
              <div className="addDocs">
                <label htmlFor="addDocument" className="addDocument">
                  {content[lang].edit_Docs}
                </label>
                <input
                  className="inp"
                  type="file"
              ...
              {docs.map((type) => (
                <div
                  ...
                  key={type}
                  style={{
                    background: `url(${type})no-repeat center center/cover`,
                  }}
                >
            ...
            <div className="priceSubmit">
              ...
              />
              <button onClick={Submit} className="btnSubmit">
                {content[lang].edit_Submit}
              </button>
            </div>
          </div>
        </div>
