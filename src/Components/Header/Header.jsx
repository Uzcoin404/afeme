...
function Header() {
  ...
  // Memoize the user location display logic
  const userLocation = useMemo(() => {
    if (!user.hasOwnProperty("data")) {
      return IP?.region;
    }

    const regionName = user.data?.region_id;
    switch (lang) {
      case "uz":
        return regionName?.name_uz;
      case "ru":
        return regionName?.name_ru ?? IP?.region;
      case "en":
        return regionName?.name_en ?? IP?.region;
      default:
        return IP?.region;
    }
  }, [user, IP, lang]);
              ...
              <div className="header__icons-nav">
                ...
                >
                  ...
                  >
                    ...
                    >
                      <MenuItem value="uz">
                        <img className="header__select-img" src={flagUz} />
                        O'zbekcha
                      </MenuItem>
                      <MenuItem value="en">
                        <img className="header__select-img" src={flagEn} />
                        English
                      </MenuItem>
                      <MenuItem value="ru">
                        <img className="header__select-img" src={flagRu} />
                        Русский
                      </MenuItem>
                    </Select>
                  </IconButton>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <MenuItem value="sum">So'm (uzs)</MenuItem>
