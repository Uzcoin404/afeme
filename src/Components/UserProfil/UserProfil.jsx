            ...
            <Container>
                <div className="user-profil-wrap">
                    ...
                    <div className="personal">
                        <div className="pic">
                            <img className="profile" src={pic && pic != 'null' ? pic : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRI7M4Z0v1HP2Z9tZmfQaZFCuspezuoxter_A&usqp=CAU"} alt="profile" />
                            <div className="edit">
